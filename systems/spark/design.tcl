...
# Workaround for not having the other 2 eth_pcs_pma instances
...
connect_bd_net [get_bd_pins gmii_mux_1/gmii_out_tx_en] [get_bd_pins util_ds_buf_sfp_tx_3/OBUF_IN]
...
connect_bd_net [get_bd_pins eth_pcs_pma_shared/clk125_out] [get_bd_pins util_ds_buf_sfp_tx_5/OBUF_IN]
...
set_property -dict [list CONFIG.NUM_PORTS {4}] [get_bd_cells xlconcat_1_0]
...
#connect_bd_net [get_bd_pins axi_ethernet_5/mac_irq] [get_bd_pins xlconcat_1_0/In0]
#connect_bd_net [get_bd_pins axi_ethernet_5/interrupt] [get_bd_pins xlconcat_1_0/In1]
#connect_bd_net [get_bd_pins axi_ethernet_5_dma/mm2s_introut] [get_bd_pins xlconcat_1_0/In2]
#connect_bd_net [get_bd_pins axi_ethernet_5_dma/s2mm_introut] [get_bd_pins xlconcat_1_0/In3]
...
set_property -dict [list CONFIG.JITTER_SEL {Max_I_Jitter} CONFIG.PRIM_SOURCE {Single_ended_clock_capable_pin} CONFIG.PRIM_IN_FREQ {10.000} CONFIG.JITTER_OPTIONS {PS} CONFIG.CLKIN1_UI_JITTER {5403.000} CONFIG.CLKIN2_UI_JITTER {100.000} CONFIG.CLKIN1_JITTER_PS {5403.000} CONFIG.CLKIN2_JITTER_PS {100.000} CONFIG.MMCM_BANDWIDTH {LOW} CONFIG.MMCM_CLKFBOUT_MULT_F {120.000} CONFIG.MMCM_CLKIN1_PERIOD {100.000} CONFIG.MMCM_CLKIN2_PERIOD {10.0} CONFIG.MMCM_REF_JITTER1 {0.054} CONFIG.MMCM_REF_JITTER2 {0.010} CONFIG.CLKOUT1_JITTER {213.462} CONFIG.CLKOUT1_PHASE_ERROR {601.651}] [get_bd_cells clk_wiz_2]
...
#connect_bd_net [get_bd_pins clk_wiz_1/ref_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
...
# axi_gpio out: 0-loopback, 1-clk_wiz_0.clk_in_sel, 2-clk_wiz_1.clk_in_sel; in: 0-loopback, 1-clk_wiz_1.locked, 2-clk_wiz_0.locked, 3-clk_wiz_2.locked
# 4-eth_pcs_pma_shared/rx_locked, 5-eth_pcs_pma_shared/tx_locked

create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0
set_property -dict [list CONFIG.C_GPIO_WIDTH {6}] [get_bd_cells axi_gpio_0]
...
set_property -dict [list CONFIG.NUM_PORTS {6}] [get_bd_cells axi_gpio_0_concat]
...
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice axi_gpio_0_slice_2_2
set_property -dict [list CONFIG.DIN_TO {0} CONFIG.DIN_FROM {0} CONFIG.DIN_WIDTH {6} CONFIG.DOUT_WIDTH {1}] [get_bd_cells axi_gpio_0_slice_0_0]
set_property -dict [list CONFIG.DIN_TO {1} CONFIG.DIN_FROM {1} CONFIG.DIN_WIDTH {6} CONFIG.DOUT_WIDTH {1}] [get_bd_cells axi_gpio_0_slice_1_1]
set_property -dict [list CONFIG.DIN_TO {2} CONFIG.DIN_FROM {2} CONFIG.DIN_WIDTH {6} CONFIG.DOUT_WIDTH {1}] [get_bd_cells axi_gpio_0_slice_2_2]

connect_bd_net [get_bd_pins axi_gpio_0_slice_0_0/din] [get_bd_pins axi_gpio_0/gpio_io_o]
connect_bd_net [get_bd_pins axi_gpio_0_slice_1_1/din] [get_bd_pins axi_gpio_0/gpio_io_o]
connect_bd_net [get_bd_pins axi_gpio_0_slice_2_2/din] [get_bd_pins axi_gpio_0/gpio_io_o]
connect_bd_net [get_bd_pins axi_gpio_0_slice_0_0/dout] [get_bd_pins axi_gpio_0_concat/In0]
...
connect_bd_net [get_bd_pins eth_pcs_pma_shared/rx_locked] [get_bd_pins axi_gpio_0_concat/In4]
connect_bd_net [get_bd_pins eth_pcs_pma_shared/tx_locked] [get_bd_pins axi_gpio_0_concat/In5]
#connect_bd_net [get_bd_pins clk_wiz_1/clk_stop] [get_bd_pins axi_gpio_0_concat/In4]
#connect_bd_net [get_bd_pins clk_wiz_1/clk_glitch] [get_bd_pins axi_gpio_0_concat/In5]
#connect_bd_net [get_bd_pins clk_wiz_1/clk_oor] [get_bd_pins axi_gpio_0_concat/In6]
